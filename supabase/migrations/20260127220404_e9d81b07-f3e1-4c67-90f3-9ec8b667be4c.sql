-- Update create_secure_order function to use distance-based pricing
-- K10 per kilometer, driver gets 80% of delivery fee
...
BEGIN
  ...
  -- Create order with server-validated values (now including coordinates and distance)
  INSERT INTO orders (
    customer_id, 
    supermarket_id, 
    delivery_zone_id,
    ...
    v_subtotal, 
    v_service_fee, 
    v_delivery_fee,  -- Now stores distance-based delivery fee
    v_total, 
    v_driver_payout
